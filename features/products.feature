...
Scenario: Update a Product
    ...
    And I press the "Clear" button
    And I paste the "Id" field
    And I set the "Name" to "Hat Updated"
    And I press the "Update" button
    Then I should see the message "Success"
    And I should see "Hat Updated" in the "Name" field
...
Scenario: List all Products
    ...
    Then I should see the message "Success"
    And I should see "Hat" in the results table
    And I should see "Shoes" in the results table
    And I should see "Big Mac" in the results table
    And I should see "Sheets" in the results table
...
Scenario: Search Products by Category
    ...
    And I should see "Hat" in the results table
    And I should see "Shoes" in the results table
    And I should not see "Big Mac" in the results table
    And I should not see "Sheets" in the results table
...
Scenario: Search Products by Availability
    ...
    And I should see "Big Mac" in the results table
    And I should see "Sheets" in the results table
    And I should not see "Shoes" in the results table
...
Scenario: Search Products by Name
    ...
    Then I should see the message "Success"
    And I should see "Big Mac" in the results table
    And I should not see "Hat" in the results table
    And I should not see "Shoes" in the results table
    And I should not see "Sheets" in the results table
